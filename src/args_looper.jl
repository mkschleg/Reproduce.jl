...
function ArgLooper(dict_list::Vector{<:Dict}, stable_arg::Dict, run_param, run_iter)
    ArgLooper(dict_list, runs_iter, stable_arg, false, run_param)
end

function ArgLooper(str_list::Vector{Vector{String}}, stable_arg::Vector{String}, run_param, runs_iter)
